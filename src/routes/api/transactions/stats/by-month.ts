import { getMonthlyStats } from '#/db/txQueries';
import { createFileRoute } from '@tanstack/react-router';
import type { Category } from 'txcategorizer';

export const Route = createFileRoute('/api/transactions/stats/by-month')({
    server: {
        handlers: {
            GET: async ({ request }) => {
                ...
                return Response.json(await getMonthlyStats(query));
            },
        },
    },
});
